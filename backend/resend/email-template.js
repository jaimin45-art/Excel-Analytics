      ...
      <tbody>
        <tr style="width:100%">
          <td><img alt="Koala" height="50" src="https://react-email-demo-k6qpz0pxq-resend.vercel.app/static/koala-logo.png" style="display:block;outline:none;border:none;text-decoration:none;margin:0 auto" width="170" />
            ...
            <p style="font-size:16px;line-height:26px;margin:16px 0">Welcome In Excel-Analytics PLateform.</p>
            
            <p style="font-size:16px;line-height:26px;margin:16px 0">Best,<br />The Development team</p>
          </td>
        </tr>
      </tbody>
    </table><!--/$-->
